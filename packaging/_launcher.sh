...
#
# The user double-clicks "Install Hype-Coin Engine" / "Uninstall Hype-Coin
...
Type=Application
Version=1.0
Name=Uninstall Hype-Coin Engine
Comment=Remove the Hype-Coin Predictive Engine service, files and user
...
case "$ACTION" in
  ...
  __install_root)
    ...
    if [[ $rc -eq 0 ]]; then
      ...
      echo "Registered 'Uninstall Hype-Coin Engine' in the app grid."
    else
